...
#num_diagnosis, num_procedures and num_medications
...
summary(reg1)
#max_glu_serumNone and max_glu_serumNorm

#-----------------------------------------------

# 12) Comment on adj-R-squared value. Comment on model's significance as a whole.

#30% of variation is explained by the model
...
#Test set -0.000000000000008491987 2.476164 1.858949 -42.51244 67.22577
...
#                 ME     RMSE      MAE       MPE     MAPE
#Test set  0.01339925 2.448957 1.882038 -40.65776 65.78725
...
#However, a ME of 0.01339925 is relatively small and may be considered acceptable depending on the specific problem and context.
