...
#Accuracy: The proportion of correct predictions is 64.44% in this case.
#Specificity: The proportion of actual negative cases that are correctly identified by the model, is 56.21% 
...
new.df$INJURY <- predict(default.ct, newdata = new.df, type = "class")

#The predicted injury status for the new traffic accident is "NO".
