...
#if Brushes are purchased then there is 100% confidence that Nail.Polish will be bought
# This rule has a lift ratio of 3.57 which means that  Nail.Polish are likely to be purchased 3.57 times
# when Brushes are purchased

# 11) What is the meaning of the support and confidence in the second rule?

#In the second rule, the support is 0.119, which means that 11.9% of all transactions 
#in the dataset contain both {Blush, Concealer, Eye.shadow} and {Mascara}.

#The confidence is 0.9596774, which means that out of all the transactions that
#contain {Blush, Concealer, Eye.shadow}, 95.97% also contain {Mascara}.
